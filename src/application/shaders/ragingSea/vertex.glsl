...
uniform float u_bigWaveElevation;
uniform vec2  u_bigWaveFrequency;
...
void main() {
    ...
    float elevation = 
        sin(modelPosition.x * u_bigWaveFrequency.x + u_time * u_BigWaveSpeed) *
        sin(modelPosition.z * u_bigWaveFrequency.y + u_time * u_BigWaveSpeed) * u_bigWaveElevation;
